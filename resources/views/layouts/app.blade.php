...
<head>
    ...
    <title>{{ config('app.name', 'VacationRental') }}</title>
                ...
                <div class="row justify-content-between">
                    <div class="col d-flex align-items-center">
                        <p class="mb-0 phone"><span class="mailus">Phone no:</span> <a href="#">+00 1234 567</a>
                            or <span class="mailus">email us:</span> <a href="#">vacationrental@gmail.com</a></p>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-8">
                        ...
                        <p class="copyright mb-0">
                            ...
                            </script> Vacation Rental. All rights reserved
                            Developed by <a href="https://jabedhosen.netlify.app/" target="_blank">Jabed Hosen</a>
                        </p>
                    </div>
